...
hdlstuff_activate() {
    ...
    hdlstuff_set_var "SYSTEMC_HOME" "$HDLSTUFF_PREFIX"
    hdlstuff_set_var "SYSTEMC_INCLUDE" "$HDLSTUFF_PREFIX/include"
    hdlstuff_set_var "SYSTEMC_LIBDIR" "$HDLSTUFF_PREFIX/lib"

    hdlstuff_set_var "VERILATOR_ROOT" "$HDLSTUFF_PREFIX"
...
hdlstuff_deactivate() {
    ...
    hdlstuff_reset_var "SYSTEMC_HOME"
    hdlstuff_reset_var "SYSTEMC_INCLUDE"
    hdlstuff_reset_var "SYSTEMC_LIBDIR"

    hdlstuff_reset_var "VERILATOR_ROOT"
